      ...
      <div className="relative mx-auto grid max-w-[1180px] grid-cols-[1.05fr_0.95fr] items-center gap-16 px-7 pb-[84px] pt-[74px] max-[980px]:grid-cols-1 max-[980px]:gap-10">
        <div>
          ...
          <Reveal className="mt-5" delay={0.08}>
            <h1 className="font-serif text-[54px] font-semibold leading-[1.08] tracking-[-1px] text-white max-[980px]:text-[42px] max-[520px]:text-[34px]">
              Turn your toughest brief into <span className="italic text-gt-mint">first-class</span> academic work.
            </h1>
          </Reveal>
          <Reveal className="mt-5" delay={0.16}>
            <p className="max-w-[540px] text-[18px] leading-[1.6] text-[#bccbd8]">
          ...
          <Reveal className="mt-[30px]" delay={0.24}>
            <div className="flex gap-[14px] max-[520px]:flex-col max-[520px]:items-stretch">
              <a
                href="#quote"
          ...
          <Reveal className="mt-[34px]" delay={0.32}>
